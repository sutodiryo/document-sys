...
@section('title', 'Show ' . ucfirst(config('settings.file_label_singular')))
...
@section('content')
                    ...
                    <div class="card-header pt-8">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
                                ...
                                @else
                                    <a href="{{ route('files.unlock', ['id' => $file->id]) }}"
                                        class="btn btn-sm btn-primary me-3">
                            ...
                            <div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
                                <a href="{{ route('files.downloadZip', ['dir' => 'original', 'id' => $file->id]) }}"
                                                    ...
                                                    @foreach ($file->activities as $activity)
                                                        {{-- <li>
                                                            <i class="fa fa-user bg-aqua" data-toggle="tooltip"
                                                                title="{{ $activity->created_by->name }}"></i>
            ...
            <div class="modal-content">
                <form class="form" action="none" id="kt_modal_lock_form">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('files.lock', ['id' => $file->id]) }}" type="button"
    ...
    <div class="modal fade" id="kt_modal_share_file" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-800px">
            ...
            <div class="modal-content">
                {!! Form::open(['route' => ['files.mail.share', $file->id], 'method' => 'post']) !!}
                        ...
                        <div class="mb-10">
                            ...
                            <div class="d-flex flex-column mb-10 fv-row">
                                ...
                                <select name="email" id="share_to_email" data-control="select2"
                                    ...
                                    <option value="yanuar@mediatechindo.com">yanuar@mediatechindo.com</option>
                ...
                <div class="modal-footer flex-center">
                    ...
                    href="{{ route('files.mail.share', ['id' => $file->id, 'curent_link' => Request::url()]) }}">Share</a> --}}
                    <!--end::Button-->
                </div>
                {!! Form::close() !!}
    ...
    <div class="modal fade" id="kt_modal_approval" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                {!! Form::open(['route' => ['files.mail.approval', $file->id], 'method' => 'post']) !!}
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header" id="kt_modal_upload_new_version_header">
                    <h2>Upload a new version of "{{ $file->name }}"</h2>
                    <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                        <i class="ki-duotone ki-cross fs-1">
                            <span class="path1"></span>
                            <span class="path2"></span>
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_upload_new_version_scroll" data-kt-scroll="true"
                        ...
                        <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-10 p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                <div class="fw-semibold">
                                    <h4 class="text-gray-900 fw-bold">Please Note!</h4>
                                    <div class="fs-6 text-gray-700">New version file will update your main file
                                        attached...
                                        {{-- <a href="#">a</a> --}}
                                    </div>
                                </div>
