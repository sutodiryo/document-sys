...
@section('title', ucfirst(config('settings.file_label_plural')) . ' List')
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="d-flex flex-column">
                                ...
                                <div class="text-muted fw-bold">
                                    <a href="{{ route('file.mail.share', 1) }}">Keenthemes</a>
                            ...
                            <div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
                                ...
                                <div>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                                        ...
                                        <form action="{{ route('file.store', 1) }}" method="POST"
                ...
                <div class="card-body">
                    @livewire('component.upload-files', ['id' => 'docs', 'error' => 'docs'])
                    ...
                    <div class="d-flex flex-stack mt-8 mb-8">
                        <div class="badge badge-lg badge-light-primary">
                            <div class="d-flex align-items-center flex-wrap">
                                ...
                                <a href="{!! route('folder.index') !!}">Home </a>
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            @foreach ($files as $file)
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                                            <input id="check_file_{{ $file->id }}" class="form-check-input"
                                                type="checkbox" name="check_file_{{ $file->id }}"
                                                value="{{ $file->id }}" />
                                        </div>
                                    </td>
                                    <td data-order="{{ $file->id }}">
                                        <div class="d-flex align-items-center">
                                            <a href="{{ route('files.show', $folder->id) }}">
                                                <span class="icon-wrapper">
            ...
            <div class="modal fade" id="kt_file_manager_new_folder" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        {{-- {!! Form::open(['route' => 'files.store-folder']) !!} --}}
