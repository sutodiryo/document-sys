...
<body id="kt_body" class="app-blank">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid stepper stepper-pills stepper-column stepper-multistep"
            ...
            <div class="d-flex flex-column flex-lg-row-auto w-lg-350px w-xl-500px">
                <div class="d-flex flex-column position-lg-fixed top-0 bottom-0 w-lg-350px w-xl-500px scroll-y bgi-size-cover bgi-position-center"
                    style="background-image: url({{ asset('metronic_8.2.6/media/misc/auth-bg.png') }})">
                    <div class="d-flex flex-center py-10 py-lg-20 mt-lg-20">
                        <a href="/metronic8/demo1/index.html">
                            <img alt="Logo" src="{{ asset('metronic_8.2.6/media/logos/custom-1.png') }}"
                                class="h-70px" />
                        </a>
                    </div>
                                    ...
                                    <div class="fv-row">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="radio" class="btn-check" name="account_type"
                                                    value="corporate"
                                                    id="kt_create_account_form_account_type_corporate" disabled />
                                                <label
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                <img src="{{ asset('metronic_8.2.6/media/svg/card-logos/visa.svg') }}"
                                                    alt="" class="h-25px" />
                                                <img src="{{ asset('metronic_8.2.6/media/svg/card-logos/mastercard.svg') }}"
                                                    alt="" class="h-25px" />
                                                <img src="{{ asset('metronic_8.2.6/media/svg/card-logos/american-express.svg') }}"
                                                    alt="" class="h-25px" />
                                            </div>
                                            <!--end::Card logos-->
                                        </div>
                            ...
                            <div class="d-flex flex-stack pt-15">
                                <div class="mr-2">
                                    <button type="button" class="btn btn-lg btn-light-primary me-3"
                                        ...
                                        <i class="ki-duotone ki-arrow-left fs-4 me-1"><span
                                                class="path1"></span><span class="path2"></span></i> Previous
                                    </button>
                                </div>
                                ...
                                <div>
                                    <button type="button" class="btn btn-lg btn-primary"
                                        ...
                                        <span class="indicator-label">
                                            Submit
                                            <i class="ki-duotone ki-arrow-right fs-4 ms-2"><span
                                    ...
                                    {{-- <button type="button" class="btn btn-lg btn-primary"
                                        ...
                                        Continue
                                        <i class="ki-duotone ki-arrow-right fs-4 ms-1"><span
                                                class="path1"></span><span class="path2"></span></i> </button> --}}


                                    <a type="button" class="btn btn-lg btn-primary" href="{{ route('login') }}">
                                        Continue
                                        <i class="ki-duotone ki-arrow-right fs-4 ms-1"><span
    ...
    <script src="{{ asset('metronic_8.2.6/js/custom/utilities/modals/create-account.js') }}"></script>
</body>
