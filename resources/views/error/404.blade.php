...
<body id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        <style>
            body {
                background-image: url('{{ asset('metronic_8.2.6/media/auth/bg1.jpg') }}');
            }

            [data-bs-theme="dark"] body {
                background-image: url('{{ asset('metronic_8.2.6/media/auth/bg1-dark.jpg') }}');
            }
        </style>
            ...
            <div class="d-flex flex-column flex-center text-center p-10">
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <div class="fw-semibold fs-6 text-gray-500 mb-7">Maybe expired.</div>
                        <div class="mb-3">
                            <img src="{{ asset('metronic_8.2.6/media/auth/404-error.png') }}" class="mw-100 mh-300px theme-light-show"
                                alt="" />
                            <img src="{{ asset('metronic_8.2.6/media/auth/404-error-dark.png') }}" class="mw-100 mh-300px theme-dark-show"
                                alt="" />
                        </div>
                        <div class="mb-0">
                            <a href="{{ route('login') }}" class="btn btn-sm btn-primary">Home</a>
                        </div>
                    </div>
                </div>
            </div>
