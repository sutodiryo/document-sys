                                ...
                                <tr>
                                    <td align="center" valign="center" style="text-align:center; padding-bottom: 0px">
                                        ...
                                        <div style="text-align:center; margin-bottom:5px">
                                            <div style="font-size: 14px; font-weight: 500; margin:0 60px 30px 60px; font-family:Arial,Helvetica,sans-serif">
                                                <p style="color:#181C32; font-size: 18px; font-weight:500; line-height:1.4; margin-bottom:24px">
                                                    Note :
                                                    <br>
                                                    {!! $data['resolution'] !!}
                                                </p>
                                        ...
                                        <a href="{{ route('public.approval.folder', ['id' => $data['id']]) }}"
                                            target="_blank"
                                            style="background-color:#50cd89; margin-bottom: 70px; border-radius:6px;display:inline-block; margin-left:0px; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;">
                                            Start approval
                                        </a>
                                    </td>
                                </tr>
