                            ...
                            <tbody>
                                <tr>
                                    <td align="center" valign="center" style="text-align:center; padding-bottom: 0px">
                                        <div style="text-align:left; margin-bottom:5px">
                                            ...
                                            <div style="font-size: 14px; font-weight: 500; margin:0 60px 30px 60px; font-family:Arial,Helvetica,sans-serif">
                                                <p
                                                    ...
                                                    Hello, {{ $data['user_name'] }} <br> welcome to document systems :
                                                </p>
                                        ...
                                        <a href="{{ route('login') }}" target="_blank" style="background-color:#50cd89; margin-bottom: 20px; border-radius:6px;display:inline-block; margin-left:0px; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;">
                                            Login
                                        </a>
                                    </td>
                                </tr>
                                    ...
                                    <td align="center" valign="center"
                                        ...
                                        <p style="margin-bottom:4px">You may reach us at
                                            <a href="https://devs.keenthemes.com" rel="noopener" target="_blank"
                                                style="font-weight: 600">docsys.com</a>.
                                        </p> --}}
