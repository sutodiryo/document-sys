                            ...
                            <tbody>
                                <tr>
                                    <td align="center" valign="center" style="text-align:center; padding-bottom: 0px">
                                        ...
                                        <a href="{{ route('resolution.folder.view', ['id' => $data['id']]) }}" target="_blank" style="background-color:#50cd89; margin-bottom: 70px; border-radius:6px;display:inline-block; margin-left:0px; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;">
                                            Start approval {{ $data['name'] }}
                                        </a>
                                    </td>
                                </tr>
                                <tr>
